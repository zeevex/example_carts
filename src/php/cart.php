...
<form action="<?php echo $ZESA_ACTION ?>" >
    ...
    <fieldset >
        ...
        <label for="custom">custom</label> <input type="text" name="custom" value="" /> <br/>
    ...
    <fieldset >
        ...
        <label for="amount">amount</label> <input type="text" name="amount" value="172.30" /> <br/>

        <label for="invoice">invoice</label> <input type="text" name="invoice" value="4 - James Whitfield" /> <br/>
        <label for="item_name">item_name</label> <input type="text" name="item_name" value="Your Store" /> <br/>
        ...
        <label for="cancel_return">cancel_return</label> <input type="text" name="cancel_return" value="<?php echo $EXAMPLE_CANCEL_URL ?>" /> <br/>
        <label for="notify_url">notify_url</label> <input type="text" name="notify_url" value="<?php echo $EXAMPLE_IPN_URL ?>" /> <br/>
        <label for="return">return</label> <input type="text" name="return" value="<?php echo $EXAMPLE_RECEIPT_URL ?>" /> <br/>
